...
function mountCarousel(container) {
  ...
  // <Carousel> below) — a static placeholder sibling (see recipes.php /
  // products.php) reserves its exact box pre-mount so this swap doesn't
  // shift the layout. Once the real arrows exist, the placeholder must go.
  const arrowsPlaceholder = container.nextElementSibling;
